...
    # ------------------------------------------------------------------
    def _send(self, to: list[dict[str, str]], subject: str, html_content: str,
...
        self, cabinet, benches: list[dict[str, Any]], note: str | None, user_email: str | None,
    ) -> dict[str, Any]:
        """
...
        """
        operator_names = ", ".join(
            b.get("operator_name") or str(b.get("tour_operator_id")) for b in benches
...
        self, cabinet, user_email: str, benches: list[dict[str, Any]],
    ) -> dict[str, Any]:
        operator_names = ", ".join(
            b.get("operator_name") or "your selected operator" for b in benches
...
        """
        return self._send(to=[{"email": user_email}], subject=subject, html_content=html)

    def send_user_quote_received(
        self, cabinet, user_email: str, operator_name: str, price_per_person: float,
    ) -> dict[str, Any]:
        """
